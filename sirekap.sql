...
--
-- Host: localhost:3306
-- Waktu pembuatan: 14 Jan 2025 pada 16.39
-- Versi server: 8.0.30
-- Versi PHP: 8.1.10
...
--
ALTER TABLE `tbl_kerangka_kerja`
  MODIFY `id_kak` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
...
--
ALTER TABLE `tbl_pagu_anggaran`
  MODIFY `id_pagu_anggaran` int NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT untuk tabel `tbl_riwayat_anggaran`
--
ALTER TABLE `tbl_riwayat_anggaran`
  MODIFY `id_riwayat_anggaran` int NOT NULL AUTO_INCREMENT;
