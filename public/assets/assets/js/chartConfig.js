  ...
  (function () {
    ...
    $.getJSON(base_url + "getKakDataJson", function(data) {
      ...
      $.getJSON(base_url + "getLpjDataJson", function(data) {
      // Process the data to fit the chart format
      let chartLpj = Array(12).fill(0);
      data.forEach(item => {
        chartLpj[item.bulan - 1] = item.total_kak;
      });

      $.getJSON(base_url + "getKakSelesaiDataJson", function(data) {
      // Process the data to fit the chart format
