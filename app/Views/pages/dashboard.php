                    ...
                    <div class="col-lg-12 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <h4 class="card-title mb-2">54</h4>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-6 mb-4">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <h4 class="card-title mb-2">14</h4>
                        </div>
                      </div>
                    </div>
                  </div>
                    ...
                    <ul class="p-0 m-0">
                      <li class="d-flex pb-1">
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                          <div class="me-2">
                            <h6 class="mb-0">Imunisasi Vitamin B</h6>
                            <small class="text-muted d-block mb-1">27 Maret 2024</small>
                          </div>
                          <div class="user-progress d-flex align-items-center gap-1">
                            <div class="alert alert-success alert-sm">Selesai</div>
                          </div>
                        </div>
                      </li>
                      ...
                      <li class="d-flex pb-1">
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                          <div class="me-2">
                            <h6 class="mb-0">Imunisasi Vitamin CB</h6>
                            <small class="text-muted d-block mb-1">30 Agustus 2024</small>
                          </div>
                          <div class="user-progress d-flex align-items-center gap-1">
                            <div class="alert alert-warning alert-sm">Belum Mengisi LPJ</div>
                          </div>
                        </div>
                      </li>
