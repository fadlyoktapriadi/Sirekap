                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('/users/tambah') ?>" method="post">
                        ...
                        <div class="form-floating my-3">
                            ...
                            aria-describedby="floatingInputHelp" name="alamat" required></textarea>
                        ...
                        <div class="my-3">
                            <select class="form-select" id="exampleFormControlSelect1"
                                ...
                                <option value="Esensial dan Keperawatan Kesehatan Masyarakat">Esensial dan Keperawatan Kesehatan Masyarakat</option>
