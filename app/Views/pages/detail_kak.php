            ...
            <div class="row">
                ...
                <?php if($user_login['role'] != 'Staf Unit') : ?>
                    <?php if($kak['status'] == 'Diterima') : ?>
                        ...
                        data-bs-target="#modalCenter">Batal Validasi Kerangka Acuan Kerja</button>
                    <?php else: ?>
                        <button class="btn btn-success"data-bs-toggle="modal"
                        data-bs-target="#modalCenter">Validasi Kerangka Acuan Kerja</button>
                    <?php endif; ?>
                <?php endif; ?>
                </div>
            </div>
                                ...
                                <div class="row">
                                  <div class="col mb-0">
                                    ...
                                    <input type="number" class="form-control" id="floatingInput" placeholder="Rp."
                                        aria-describedby="floatingInputHelp" name="anggaran_disetujui" value="<?= $kak['anggaran_disetujui'] ?>">
                                ...
                                <div class="row">
                                  <div class="col mb-0">
                                    <select class="form-select" id="exampleFormControlSelect1"
                                        ...
                                        <option value="Diproses" <?= ($kak['status'] == 'Diproses') ? 'selected' : '' ?>>Diproses</option>
                                        <option value="Diterima" <?= ($kak['status'] == 'Diterima') ? 'selected' : '' ?>>Diterima</option>
                                        <option value="Perbaikan" <?= ($kak['status'] == 'Perbaikan') ? 'selected' : '' ?>>Perbaikan</option>
                                        <option value="Ditolak" <?= ($kak['status'] == 'Ditolak') ? 'selected' : '' ?>>Ditolak</option>
                                    </select>
                                </div>
                                </div>
                              </div>
