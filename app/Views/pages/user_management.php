...
<div class="card">
    ...
    <div class="d-flex justify-content-between">
        ...
        <form method="get" action="<?= base_url(relativePath: "/users/cari") ?>" class="d-flex mx-4 mt-2">
            <input type="text" class="form-control me-2" placeholder="Cari Pengguna" name="keyword"
                style="height: 38px;">
            <button class="btn btn-outline-info px-5" type="submit"
                style="margin-bottom: 0px; height: 38px;">Cari</button>
        </form>
    </div>
    <div class="table-responsive text-nowrap mt-4">
        ...
        <table class="table table-hover">
            ...
            <tbody class="table-border-bottom-0">
                ...
                <tr>
                    <td><?= $i ?></td>
                    <td><i class="fab fa-angular fa-lg text-danger me-3"></i> <strong><?= $user['nama_pengguna'] ?></strong></td>
                    <td><?= $user['username'] ?></td>
                    ...
                    <td>
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="<?= base_url('users/edit/') . $user['id_pengguna'] ?>"><i class="bx bx-edit-alt me-1"></i>
                                    Edit</a>
                                <a class="dropdown-item hapusbtn" href="<?= base_url('users/hapus/') . $user['id_pengguna'] ?>"><i class="bx bx-trash me-1"></i>
                                    Delete</a>
                            </div>
                        </div>
                    </td>
