    ...
    <div class="row mx-4 mb-5">
        <div class="col-md-12">
            ...
            <table class="table">
                ...
                <tr>
                    <td>Pelaksanaan</td>
                    <td><?= date('d F Y', strtotime($kak['tanggal_mulai'])) ?> s/d <?= date('d F Y', strtotime($kak['tanggal_selesai'])) ?></td>
                </tr>
                <tr>
            ...
            <div class="row">
                <div class="col">
                    ...
                    <form action="<?= base_url('lpj/simpan') ?>" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="id_kak" value="<?= $kak['id_kak'] ?>" />
                        <div class="form-floating my-3">
                            <input type="number" class="form-control" id="floatingInput" placeholder="Jumlah pasien yang ditangani"
                                aria-describedby="floatingInputHelp" name="capaian_pelaksanaan" autofocus required />
                        ...
                        <div class="form-floating my-3">
                            <textarea name="keterangan" id="keterangan" class="form-control" id="floatingInput" placeholder="Jl. Contoh No. 1"
                            aria-describedby="floatingInputHelp" name="keterangan" required></textarea>
                            <label for="floatingInput">Keterangan Kegiatan</label>
                        </div>
                        <div class="my-3">
                            <label for="formFile" class="form-label">Dokumen Lembar Pertanggung Jawaban</label>
